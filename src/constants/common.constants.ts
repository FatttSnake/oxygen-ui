...
export const COLOR_ACTIVE = '#3A33A8'
...
export const SYSTEM_NO_EMAIL_CONFIG = 10057
...
export const PERMISSION_TOKEN_REFRESH_SUCCESS = 20003
...
export const PERMISSION_INVALID_CSRF_TOKEN = 20096
export const PERMISSION_MISSING_CSRF_TOKEN = 20097
export const PERMISSION_TOKEN_REFRESH_ERROR = 20098
export const PERMISSION_LOGIN_FAILED = 20099
...
export const TOOL_BASE_HAS_BEEN_COMPILED = 40056
export const TOOL_HAS_NOT_BEEN_DELISTED = 40057
